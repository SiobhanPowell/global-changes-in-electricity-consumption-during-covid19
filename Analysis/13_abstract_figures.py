...
axes.set_ylabel('% Change Electricity Consumption', fontsize=16)
axes.set_yticks([-25, -20, -15, -10, -5, 0])
axes.set_yticklabels([-25, -20, -15, -10, -5, 0], fontsize=16)
axes.set_ylim([-28, 3])
axes.set_xlim([datetime.date(2020,1,1), datetime.date(2020, 10, 27)])
axes.legend(fontsize=16, ncol=2, loc='lower right')
...
axes[0].set_xticklabels(['Extreme', 'Severe', 'Mild'], fontsize=16)
for i in range(3):
...
axes[1].set_xticklabels(['Slow', 'Quick', 'Recovered'], fontsize=16)
axes[0].set_yticks([0, 10, 20, 30, 40, 50, 60])
axes[0].set_yticklabels([0, 10, 20, 30, 40, 50, 60], fontsize=14)
axes[0].set_ylabel('Stringency Index', fontsize=16)
plt.tight_layout()
...
axes[0].set_yticklabels([-60, -50, -40, -30, -20, -10, 0], fontsize=14)
axes[0].set_ylabel('Mobility: Retail/Rec', fontsize=16)
plt.tight_layout()
